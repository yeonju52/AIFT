...
for i in ['20221209150000', '20221209153000', '20221209140000']:
    print(i <= '20221209153000')  

# import pandas as pd
# df = pd.DataFrame([[20221207153500,24265,24265,24265,24265,2]], columns=['date', 'open', 'high', 'low', 'close', 'volume'])
# print(len(df))
